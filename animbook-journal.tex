...
\caption{The static plot shows the points transferred from the right category A and E to the left category A before being animated. This is called a many-to-one relationship.}\label{fig:top-many}
\end{figure}

Using \texttt{subset\ =\ "B"} will only show the point for a single category as shown in the Figure \ref{fig:b-many}.
...
\caption{The static plot shows the points that got transferred to category B on the right are only from category B. The plot shown is the plot before it is being animated.}\label{fig:b-many}
\end{figure}
