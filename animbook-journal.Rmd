...
The structure of this paper is as follows. Section @NYT explains the animation in The New York Times article and why it is relevant to the problem of studying zombie companies. The next section describes the expected data format, and how it is processed. Following this, is an explanation of available the animation tools, and how they are employed for this problem.  A  section on the functions of the package and how the visualization is designed, demonstrate how the data is mapped to the animation. The last two sections illustrate the usage of the package and applications to company performance and changing political allegiance.


# Explanation of the New York Times visualization {#NYT}
...
knitr::include_graphics("figures/NYT.jpg")
```
