...
```{r top-one, echo=TRUE, fig.width=8, fig.align='center', out.width="100%", layout = "l-body", fig.cap="The static plot shows the points transferred from the left category A to the right category A and E before being animated."}
...
```{r top-many, echo=TRUE, fig.width=8, fig.align='center', out.width="100%", layout = "l-body", fig.cap="The static plot shows the points transferred from the right category A and E to the left category A before being animated. This is called a many-to-one relationship."}
...
```{r b-many, echo=TRUE, fig.width=8, fig.align='center', out.width="100%", layout = "l-body", fig.cap="The static plot shows the points that got transferred to category B on the right are only from category B. The plot shown is the plot before it is being animated."}
