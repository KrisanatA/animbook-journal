...
```{r tbl-scaling, eval=knitr::is_html_output()}
scaling_table |> 
  knitr::kable(caption = "A summary of different scaling methods applied to the dataset.")
```

```{r tbl-scaling-la, eval=knitr::is_latex_output()}
scaling_table |> 
  knitr::kable(caption = "A summary of different scaling methods applied to the dataset.") |> 
  kableExtra::column_spec(8, width = "30em")
```
